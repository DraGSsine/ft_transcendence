  ...
  return (
    <main className="flex h-[90vh] justify-between w-full">
      <section>
        ...
        >
          <div className="relative z-50 rounded-2xl flex bg-white/5 w-2/6 h-3/6 items-center p-4 backdrop-blur-lg">
            <div className=" flex">
          ...
          <div className="relative z-50 rounded-2xl flex bg-white/5 w-2/6 h-full p-4 backdrop-blur-lg flex-col justify-between ">
            <div className=" flex flex-col gap-4 items-end">
                <button className=" relative z-50 rounded-lg w-32 py-2 bg-red-600 "> Block </button>
                <button className=" relative z-50 rounded-lg w-32 py-2 bg-slate-700 "> Message </button>
                <button className=" relative z-50 rounded-lg w-32 py-2 bg-slate-700 "> Add Friend </button>
            </div>
            <div>
              ...
              <div className="h-3 w-full bg-gray-400/50 rounded-full">
                <div style={{width: `50%`}} className="h-3 bg-secondary rounded-full"></div>
              </div>
            </div>
          </div>
        </div>
